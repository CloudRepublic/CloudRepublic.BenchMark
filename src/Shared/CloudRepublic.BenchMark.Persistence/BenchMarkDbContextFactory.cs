...
namespace CloudRepublic.BenchMark.Persistence
{
    ...
    {
        BenchMarkDbContext Create(string connectionString);
    }
    public class BBenchMarkDbContextFactory : IBenchMarkDbContextFactory
    {
        public BenchMarkDbContext Create(string connectionString)
        {
