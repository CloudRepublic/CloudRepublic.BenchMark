...
$windowsSampleFunctionCsharpName = "BenchMark-Sample-Win-Csharp-3";
$windowsSampleFunctionNodejsName = "BenchMark-Sample-Win-Nodejs-3";
$linuxSampleFunctionCsharpName = "BenchMark-Sample-Lin-Csharp-3";
$linuxSampleFunctionNodejsName = "BenchMark-Sample-Lin-Nodejs-3";
...
$sampleFuncV3WindowsCsharp = az functionapp create --resource-group $resourceGroupName --name $windowsSampleFunctionCsharpNameV3 --storage-account $storageAccountName --consumption-plan-location  $consumptionLocation --runtime dotnet --os-type Windows | ConvertFrom-Json --functions-version 3

#create windows sample function V3 nodejs
$sampleFuncV3WindowsNodejs = az functionapp create --resource-group $resourceGroupName --name $windowsSampleFunctionNodejsNameV3 --storage-account $storageAccountName --consumption-plan-location  $consumptionLocation --runtime node --os-type Windows | ConvertFrom-Json --functions-version 3

#create linux sample function V3 csharp
$sampleFuncV3LinuxCsharp = az functionapp create --resource-group $resourceGroupLinuxName --name $linuxSampleFunctionCsharpNameV3 --storage-account $storageAccountLinuxName --consumption-plan-location  $consumptionLocation --runtime dotnet --os-type Linux | ConvertFrom-Json --functions-version 3

#create linux sample function V3 nodejs
$sampleFuncV3LinuxNodejs = az functionapp create --resource-group $resourceGroupLinuxName --name $linuxSampleFunctionNodejsNameV3 --storage-account $storageAccountLinuxName --consumption-plan-location  $consumptionLocation --runtime node --os-type Linux | ConvertFrom-Json --functions-version 3
